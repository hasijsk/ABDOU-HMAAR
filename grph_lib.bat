...
:: The Function was created and enhanced by Psi505, so it is not my propriety
:: You don't have the right to modify it...

:: If you want to modify it, please ask Psi505
:: If you want to use the script, here is the origianl Github : https://github.com/Psi505/Batch-GUI-Button/blob/main/Button.bat
